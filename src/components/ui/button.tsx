...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-school-sm hover:shadow-school-md hover:-translate-y-0.5",
        destructive:
        ...
        hero:
          "bg-gold text-navy-dark shadow-gold hover:shadow-lg hover:-translate-y-1 font-semibold",
        "hero-outline":
        ...
        gold:
          "bg-gold text-navy-dark shadow-gold hover:shadow-lg hover:-translate-y-0.5 font-semibold",
        navy:
          "bg-navy text-primary-foreground shadow-school-md hover:bg-navy-light hover:-translate-y-0.5",
      },
      size: {
